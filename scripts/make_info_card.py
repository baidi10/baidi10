...
# ===========================================================================
HOST = "baidi10"   # shown as  baidi10@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "CE Student @ FST Errachidia"),
    ("kv", "Prev", "Web Dev Intern @ Commune d'Arfoud"),
    ("kv", "Also", "Data/Business Analyst (365 Data Science)"),
    ("kv", "Edu", "BTS Multimedia & Web Design '25"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, JavaScript, Bootstrap"),
    ("kv", "Backend", "Laravel, PHP, MySQL"),
    ("kv", "Data / AI", "Python, pandas, SQL"),
    ("kv", "Tools", "Git, Figma, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "School mgmt platform w/ role-based access (PHP/MySQL)"),
    ("bul", "Full-stack inventory system: Laravel + React + MySQL"),
]
